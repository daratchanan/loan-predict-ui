// ============================================
// components/dashboard/LoanOfficerDashboard.tsx
// Dashboard Component เฉพาะสำหรับ Loan Officer
// ============================================
    ...
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-800">ระบบคาดการณ์การอนุมัติสินเชื่อ - Loan Officer</h1>
